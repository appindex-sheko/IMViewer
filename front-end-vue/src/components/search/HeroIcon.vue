...
export default defineComponent({
  ...
  data() {
    return {
      icons: {
        search_default: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z",
        table_default:
        ...
        microphone_default: "M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z",
        home_default:
